...
.actor_updates <- data.frame(ind = unmatched_indices,
...
.actor_updates <- rbind(.actor_updates, data.frame(ind = name_ind[18],
                                                   name_wrong = cdp$name[name_ind[18]]))
name_ind <- name_ind[-18]
...
cdp$name[grep("Canoas", cdp$name)] <- "Canoas"
