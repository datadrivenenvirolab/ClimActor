...
```{r, echo = F, comment = ""}
cat("The original name is Eskişehir Municipality with iso code TUR and entity type City
Here are some possible matches we found: 
...
.actor_updates <- rbind(.actor_updates, data.frame(ind = name_ind[5],
                                                   name_wrong = cdp$name[name_ind[5]]))
name_ind <- name_ind[-5]
